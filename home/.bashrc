...
export PATH=$PATH:~/.zls/zig-out/bin
...
# Flatbuffers
export CLASSPATH=$CLASSPATH:~/differential-datalog/flatbuffers/java
export PATH=$PATH:~/differential-datalog/flatbuffers

# Differential Datalog
export DDLOG_HOME=~/.ddlog
